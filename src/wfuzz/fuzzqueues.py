...
if TYPE_CHECKING:
    ...
    from wfuzz.plugin_api.base import BasePlugin, BasePrinter
    from wfuzz.externals.reqresp.cache import HttpCache
import time
from threading import Thread, Event
from queue import Queue
from wfuzz.externals.reqresp.Response import get_encoding_from_headers
...
class SeedQueue(FuzzQueue):
    ...
    def process(self, fuzz_item: FuzzItem):
        # STARTSEED used by the first item when wfuzz starts
...
class CLIPrinterQ(FuzzQueue):
    """
    Queue responsible for the outputs of the results. This queue will be active for "default" ways of using wfuzz to
    print to the CLI
    """
